...
func (s *Service) GetAllOrders(ctx context.Context) ([]dto.OrderResponse, error) {
...
func (s *Service) GetAllOrdersPaginated(ctx context.Context, page dto.PaginationRequest, search string) ([]dto.OrderResponse, dto.PaginationResponse, error) {
	page.Normalize()
...
func (s *Service) GetOrderByID(ctx context.Context, id string) (*dto.OrderResponse, error) {
